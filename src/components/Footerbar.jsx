         ...
         <div className="md:w-2/5">
          ...
          <div className="md:w-3/5 text-[16px] mt-3 items-start flex flex-col gap-4 ">
           ...
           <span className="cursor-pointer" onClick={() => {
            window.open(socaillink[0].linkedIn);
            }}><FaLinkedinIn className="text-white"/></span>

            <span className="cursor-pointer" onClick={() => {
              window.open(socaillink[1].instagram);
              }}><FaInstagram className="text-white"/></span>

           <span className="cursor-pointer" onClick={() => {
            window.open(socaillink[2].facebook);
            }}><FaFacebook className="text-white"/></span>

           <span className="cursor-pointer" onClick={() => {
            window.open(socaillink[3].twitter);
